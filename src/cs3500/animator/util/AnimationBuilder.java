...
/**
 * An animation builder interface that constructs the specified document with specified bounds, a
 * list of shapes, list of keyframes, and list of motions.
 *
 * @param <Doc> the doc being built.
 */
public interface AnimationBuilder<Doc> {
  ...
  /**
   * Adds a new shape with a specified layer to the growing document.
   *
   * @param name The unique name of the shape to be added. No shape with this name should already
   *             exist.
   * @param type The type of shape (e.g. "ellipse", "rectangle") to be added. The set of supported
  ...
  /**
   * Adds a transformation to the growing document including a rotation.
   *
   ...
   * @param heading1 the initial heading of the shape
   ...
   * @param heading2 the final heading of the shape
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<AnimatorModel> addMotion(String name, int t1, int x1, int y1,
   ...
   * @param heading the heading of the shape
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addKeyframe(String name,
      int t, int x, int y, int w, int h, int r, int g, int b, int heading);
}
